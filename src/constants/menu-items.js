...
const menu_items = [
  {
    ...
    price: '14.50',
    blurb:
      'Steamed to perfection in a fragrant broth of white wine, garlic, fresh herbs, and diced tomatoes, served with a side of crusty bread for soaking up every last drop of the flavorful broth. Sourced fresh daily!',
  ...
  },
  {
    ...
    price: '14.50',
    blurb:
      'Our fresh, sustainably sourced salmon fillet is marinated in lemon juice, olive oil, garlic, and Mediterranean herbs, then expertly grilled to perfection. Served atop a bed of fluffy couscous and a colorful array of roasted vegetables. A true feast for the senses.',

    description:
      'Our fresh, sustainably sourced salmon fillet is marinated in lemon juice, olive oil, garlic, and Mediterranean herbs, then expertly grilled to juicy perfection. Served atop a bed of fluffy couscous and paired with a colorful array of roasted vegetables, including bell peppers, cherry tomatoes, and zucchini, this dish is a true feast for the senses. Topped with a drizzle of tangy tzatziki sauce and a sprinkle of crumbled feta cheese. It will transport you straight to the sun-drenched shores of the Mediterranean.',
  },
  {
    image: lemonCake,
    imageAlt: 'Lemon Cake',
